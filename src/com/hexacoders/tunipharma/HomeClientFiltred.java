 ...
 * @author yossr
 */
public class HomeClientFiltred extends SideMenuBaseForm {
    ...
    public HomeClientFiltred(User u  , Resources res) {

        super(BoxLayout.y());
        currentC = this;
        Toolbar tb = getToolbar();
        setTitle("Filtred Products");
...
// sp.setText(ServiceProduct.getInstance().getAllProductsAction().toString());
         ...
         * ********************************************************************************
         */
        liste = ServiceProduct.getInstance().getFiltredProductsAction(HomeClient.enventeA, HomeClient.priceminA, HomeClient.pricemaxA);
